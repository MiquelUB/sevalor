Pla de Tasques Atòmiques d'Implementació — CampoPro Suite (v4.0)
Aquest document conté el desglossament de la planificació tècnica de CampoPro Suite en tasques de menys de 30 minuts de durada estimativa, ordenades per dependència seqüencial, indicant els requisits funcionals (RF) que cobreix cadascuna d'elles i la línia de validació "Fet quan:" per a l'assegurament de la qualitat (QA).
--------------------------------------------------------------------------------
🧱 Bloc 1: Infraestructura i Base de Dades Inicial (Fundació)
    ...
    [ ] Tasca 1.2: Definició de l'Esquema de Base de Dades - Core Multi-Tenant
    ...
    [ ] Tasca 1.4: Esquema Físic de Base de Dades - Clients i Finques amb PostGIS
        Dependència: Tasca 1.2.
    ...
    [ ] Tasca 1.5: Esquema Físic de Base de Dades - Magatzem i Inventari de Format Continu
        Dependència: Tasca 1.2.
    ...
    [ ] Tasca 1.6: Esquema Físic de Base de Dades - Flota i de Repostatges de Carburant
        Dependència: Tasca 1.2.
    ...
    [ ] Tasca 1.7: Esquema Físic de Base de Dades - Registre d'Esdeveniments SIF (Inmutable)
        Dependència: Tasca 1.2.
...
🔑 Bloc 2: Backend Core, Seguretat Multi-Tenant i Autenticació
    ...
    [ ] Tasca 2.1: Implementació de Middleware d'Extracció de Context Tenant a FastAPI
    ...
    [ ] Tasca 2.2: Test d'Integració Pytest d'Aïllament d'Inquilins (RLS)
    ...
    [ ] Tasca 2.3: API d'Enrolament Inicial de Dispositiu a la PWA (SMS OTP)
        Dependència: Tasca 2.1.
    ...
    [ ] Tasca 2.4: Mecanisme de Validació Criptogràfica Offline al Client (Web Crypto API)
        Dependència: Tasca 2.3.
        RF associats: Spec 019 (RF-05, RF-06).
        Fet quan: El script del Service Worker en JavaScript executa correctament la derivació de clau amb l'algorisme PBKDF2 (100.000 iteracions) a partir d'un PIN de 4 dígits de camp i desxifra el bloc sentinella CAMPOPRO_SENTINEL mitjançant AES-GCM-256.
    [ ] Tasca 2.5: Endpoint de Recuperació de PIN Temporal i Registre d'Incidència
        Dependència: Tasca 2.3.
...
📱 Bloc 3: Mòdul de Campo (PWA /operari)
    ...
    [ ] Tasca 3.1: Disseny Tàctil d'Inici de Sessió (Numpad) en Next.js
    ...
    [ ] Tasca 3.2: Control d'Abertura de Càmera en Viu Antifraude
    ...
    [ ] Tasca 3.3: Lògica de Compressió WebP en Client i Emmagatzematge IndexedDB
    ...
    [ ] Tasca 3.4: Pantalla de Llista de Feines del Dia amb Estat Buit Net (Zero-Mock)
        Dependència: Tasca 3.1.
    ...
    [ ] Tasca 3.5: Lògica del Botó "Iniciar Trajecte" i Notificació d'ETA
    ...
    [ ] Tasca 3.6: Bloqueig d'Inici de Feina per Control de Geovalla d'Obra
        Dependència: Tasca 3.4.
    ...
    [ ] Tasca 3.7: Pantalla de Registre d'Incidències Multimodal i Botó SOS
        Dependència: Tasca 3.1.
    ...
    [ ] Tasca 3.8: Visor Cartogràfic Tàctil amb Capes d'Anotacions As-Built
        Dependència: Tasca 3.1.
    ...
    [ ] Tasca 3.9: Control d'Edició de Plànols sobre Obres Tancades
    ...
    [ ] Tasca 3.10: Formulari de Tiquets de Despesa amb Segon Foto d'Odòmetre
        Dependència: Tasca 3.2.
...
🖥️ Bloc 4: Central Web i Administració (/gestio)
    ...
    [ ] Tasca 4.1: Panell de Control - Spotlight Meta-Search de Ràpid Rendiment
    ...
    [ ] Tasca 4.2: Triple Conciliació de Factures (Three-Way Matching) en Proveïdors
    ...
    [ ] Tasca 4.3: Bloqueig Pesimista de Reserves d'Estoc (Magatzem)
        Dependència: Tasca 1.5.
    ...
    [ ] Tasca 4.4: Enrutador de Seguretat de Rols del Backend - Veto d'Enginyer
        Dependència: Tasca 2.1.
    ...
    [ ] Tasca 4.5: Mòdul de Flota - Control d'ITV en Quatre Veredictes
...
⚙️ Bloc 5: Microserveis, Integracions i Processament Asíncron (Workers)
    ...
    [ ] Tasca 5.1: Pipeline de Transcripció d'Àudio Whisper amb Quantificació INT8
    ...
    [ ] Tasca 5.2: Bot de Telegram de Clients - Middleware de Prevenció de Doble Extensió
        Dependència: Tarea 1.1.
    ...
    [ ] Tasca 5.3: Generació de Factures Veri*factu en PDF (ReportLab) amb Codi QR
    ...
    [ ] Tasca 5.4: Outbox Pattern per a Envia de Lots SOAP de Veri*factu
    ...
    [ ] Tasca 5.5: Còpies de Seguretat de Tenants amb Filtre d'Exclusió de Recursivitat
        Dependència: Tarea 1.1.
