---
name: sevalor-guardian
description: >-
  Usa aquesta skill per consultar i fer complir els 7 mandats constitucionals, les regles d'or d'enginyeria i els patrons d'infraestructura específics de Sevalor Suite (Zero Mock Data, RLS, Web Crypto API offline, Veri*factu SHA-256, sobirania local Hetzner i proteccions de CPU).
---

# Guardià Constitucional i Patrons de Pila (Sevalor Guardian)
...
* **Patró Criptogràfic:** Derivació de clau mitjançant PBKDF2 (100.000 iteracions) a partir del PIN de 4 dígits de l'operari i xifratge simètric **AES-GCM de 256 bits** amb comprovació contra el bloc sentinella `SEVALOR_SENTINEL`.
